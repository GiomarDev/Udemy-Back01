    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<CineCreacionDTO, Cine>().
                ForMember(x => x.Ubicacion, x => x.
                MapFrom(dto => geometryFactory.
                CreatePoint(new Coordinate(dto.Longitud, dto.Latitud))));
        ...
        private List<PeliculaActorDTO> MapearPeliculasActor(Pelicula pelicula, PeliculaDTO peliculaDTO)
        {
            ...
            if (pelicula.PeliculasActores != null)
            {
                ...
                {
                    resultado.Add(new PeliculaActorDTO() { Id = actorPeliculas.ActorId, 
